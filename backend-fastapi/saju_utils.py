...
GANZHI_LIST = [
    ...
    '甲戌', '乙亥', '丙子', '丁丑', '戊寅', '己卯', '庚辰', '辛巳', '壬午', '癸미',
    '甲申', '乙酉', '丙戌', '丁亥', '戊자', '己丑', '庚寅', '辛卯', '壬辰', '癸巳',
...
TWELVE_GROWTH = {
    ...
    '辛': {'子':'장생','丑':'양','寅':'태','卯':'절','辰':'묘','巳':'사','午':'병','미':'쇠','申':'제왕','酉':'건록','戌':'관대','亥':'목욕'},
    '癸': {'卯':'장생','辰':'양','巳':'태','午':'절','未':'묘','申':'사','酉':'병','戌':'쇠','亥':'제왕','자':'건록','丑':'관대','寅':'목욕'}
}
...
# 지지 형충회합 매핑
BRANCH_RELATIONS = {
    '합': {'子':'丑', '丑':'자', '寅':'亥', '亥':'寅', '卯':'戌', '戌':'卯', '辰':'酉', '酉':'辰', '巳':'申', '申':'巳', '午':'未', '未':'午'},
    ...
    '파': {'子':'酉', '酉':'子', '丑':'辰', '辰':'丑', '寅':'亥', '亥':'寅', '卯':'午', '午':'卯', '巳':'申', '申':'巳', '未':'戌', '戌':'미'},
    '해': {'子':'未', '未':'子', '丑':'午', '午':'丑', '寅':'巳', '巳':'寅', '卯':'辰', '辰':'卯', '申':'亥', '亥':'申', '酉':'戌', '戌':'酉'},
    '원진': {'子':'未', '未':'子', '丑':'午', '午':'丑', '寅':'酉', '酉':'寅', '卯':'申', '申':'卯', '辰':'亥', '亥':'辰', '巳':'戌', '戌':'巳'},
    '귀문': {'子':'未', '未':'子', '丑':'午', '午':'丑', '寅':'미', '未':'寅', '卯':'申', '申':'卯', '辰':'亥', '亥':'辰', '巳':'戌', '戌':'巳'}
}
