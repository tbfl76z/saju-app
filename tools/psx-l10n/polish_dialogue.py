...
アルシア=아르시아, ビシヌ=비쉬누, ヴァインスタイン=번스타인,
パルタミーラ=팔타밀라, アシュラン=아슈람, スタムブリンガー=스탐블링거,
...
def main():
    ...
    speaker_names.update({
        ...
        "ドラウ": "드라우프니르", "ランダム": "랜담", "アルシア": "아르시아",
        "ヴァインスタイン": "번스타인", "ビシヌ": "비쉬누", "アシュラン": "아슈람",
        "ジャビエル": "자비에르", "カリパー戦士": "캘리퍼 전사",
        "カリパー人": "캘리퍼인", "公王": "공왕", "兵士": "병사",
        "ガード": "경비병", "暗黒殺部隊": "흑영대", "天空牙城": "천공의 아성",
        "元老院将軍": "원로원 장군", "伝令兵": "전령병", "火竜": "화룡",
        "ビスバーデン": "비스바덴", "オブスクラ": "오브스쿠라",
        "サイラップス": "사이럽스", "リオス港": "리오스 항구",
        "オデッセイ号": "오딧세이호", "爆風島": "폭풍도",
    })
