...
const GUIDE_STEPS: [string, string][] = [
    ...
    ["STEP 1 이렇게는 재지 마세요", "집 한가운데 서서 창 쪽을 눈대중으로 겨누는 방식은 쓰면 안 됩니다. 창은 점이 아니라 면이라, 창의 왼쪽 끝을 겨누느냐 오른쪽 끝을 겨누느냐에 따라 20~30도가 흔들립니다. 24산은 15도 단위로 끊기니 산이 통째로 넘어가 버립니다. '집 중심'은 STEP 3 도면에서 8궁을 나눌 때 쓰는 것이고, 각도 재기와는 별개 단계입니다."],
    ...
    return (
        <div className="space-y-3">
            ...
            <div className="glass-card p-4 space-y-3">
                ...
                {/* 재는 법 — 흔한 오해(집 중앙에서 창을 겨눔)를 측정 버튼 바로 위에서 차단한다.
                    나침반은 위치를 모르고 방향만 읽으므로, 값을 만드는 것은 '서는 자리'가 아니라 '폰의 정렬'이다. */}
