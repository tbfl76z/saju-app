...
const GUIDE_STEPS: [string, string][] = [
    ...
    ["STEP 1 입주년", "이 집에 이사 온(또는 집이 지어진) 연도를 넣으세요. 시기에 따라 기운의 판이 달라지기 때문입니다."],
    ...
    ["STEP 3 도면", "우리 집 평면도나 위성지도 캡처를 불러온 뒤, 사진 속 집 가운데를 손가락으로 콕 찍으세요. 방금 잰 방향 그대로 기운 지도가 사진 위에 그려집니다. 위성지도 캡처는 위쪽이 북쪽이라 그대로 쓰면 되고, 도면이 돌아가 있으면 슬라이더로 위쪽 방위만 맞춰 주세요."],
