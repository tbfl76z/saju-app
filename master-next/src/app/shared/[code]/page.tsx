            ...
            <header className="glass-card !rounded-none border-t-0 border-x-0 border-b-white/20 dark:border-b-white/10 py-3 md:py-5 px-4 md:px-6 mb-5 md:mb-12">
                <div className="max-w-4xl mx-auto flex items-center justify-between">
                    <Link href="/" className="flex items-center gap-3 group">
                        ...
                        <img src="/logo.svg" alt="Destiny Master 로고" className="w-12 h-12 drop-shadow" />
                        <div>
                            <h1 className="text-2xl font-extrabold text-slate-900 dark:text-slate-50 tracking-tight font-noto-serif">Destiny Master</h1>
